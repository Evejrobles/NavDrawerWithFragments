...
public class DemoFragment extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    View view = inflater.inflate(com.deepdive.navdrawerwithfragments.R.layout.fragment_demo, container, false);
    ImageView demoImage = view.findViewById(com.deepdive.navdrawerwithfragments.R.id.demo_image);
